...
The launcher uses the Python interpreter inside the project's `.venv` directory and does not require the virtual environment to be activated first.

WireAtlas can also be started manually with:
